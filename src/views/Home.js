...
const HomePage = ({navigation}) => {
  ...
  const handlePressCircle4 = () => {
    // navigate to page 3
    navigation.navigate('AddListing1');
  };
        ...
        <View style={styles.container}>
          ...
          <View style={styles.second_container}>
            ...
            <View style={styles.circle_container}>
              <TouchableOpacity
                onPress={handlePressCircle1}
                style={styles.circle}>
                <Image
                  source={require('../../assets/images/dog-gba5dc7061_1920.jpg')}
                  style={styles.image_circle}
                />
              </TouchableOpacity>
              <TouchableOpacity
                onPress={handlePressCircle2}
                style={styles.circle}>
                <Image

...
const InputField = ({text_title="", text_color=COLORS.black, onChangeText, defaultValue, value, icon, multiline = false, numberOfLines }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.innerContainer({multiline})}>
        ...
        <View style={[styles.iconContainer, icon ? styles.iconContainer.marginHorizontal = 5 : styles.iconContainer.marginHorizontal = 0]}>
          {icon}
        </View>
      </View>

...
export default class AnimalCards extends React.Component {
  constructor(props) {
    ...
    this.addToFavorites = async () => {
      ...
      like_animal(userID, this.state.currentItem).catch(error => {
        console.log(error);
      });
          ...
          if (i < this.state.currentIndex) {
            ...
            return (
              <Animated.View
                ...
                style={[this.rotateAndTranslate, styles.container]}>
                <Animated.View
                  style={[styles.favoriteIcon, {opacity: this.likingOpacity}]}>
                  <Icon
                    name="favorite"
                    size={100}
                    color={COLORS.background2}></Icon>
                </Animated.View>
                <View style={{flexDirection: 'column'}}>
                  {item.animalImageLink !== '' ? (
                    <Image
                      style={[styles.image]}
                      source={{uri: item.animalImageLink}}
                    />
                  ) : null}
            ...
            return (
              <Animated.View
                ...
                style={[
                  {
                    transform: [
                      {translateX: this.nextCardPositionX},
            ...
            return (
              <Animated.View
                ...
                style={[
                  ...
                  {
                    transform: [
                      {translateX: this.card2PositionX},
            ...
            return (
              <Animated.View
                ...
                style={[
                  ...
                  {
                    transform: [
                      {translateX: this.card3PositionX},
  ...
  render() {
    ...
    return <>{this.state.isLoading ? <Text>Loading...</Text> : renderanimal}</>;
  }
}
